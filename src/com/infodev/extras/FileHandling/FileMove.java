...
public class FileMove {
    ...
    /**
     * Takes fileName and its extension as parameters and moves that file from FileHandling-Source to FileHandling-Destination of Desktop
     *
     * @param fileName      Name of the file excluding the extension
     * @param fileExtension The dot(.) extension of the file
     */
    public static void moveFile(String fileName, String fileExtension) {
        ...
        try {
            ...
            //delete the source file after the moving is successful
            sourceFile.deleteOnExit();
            //print moving successful message
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This program moves a file from 'C:\\Users\\Nabin\\Desktop\\FileHandling-Source' folder to 'C:\\Users\\Nabin\\Desktop\\FileHandling-Destination' folder");
